# Proof of Backpropagation Formulas

## Proof of \( \frac{\partial C}{\partial b_j^l} = \delta_j^l \)
...
## Proof of \( \frac{\partial C}{\partial w_{jk}^l} = a_k^{l-1} \delta_j^l \)
...
which is a fundamental equation in backpropagation. ✅ 🚀
